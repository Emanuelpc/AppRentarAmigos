...
function PerfilAmigo() {
  ...
  const { nombre, apellido, descripcion, imagenUrl, genero, edad } =
    location.state?.data || {};
...
>>>>>>> 37d8c983e0256824a93c65f23dff192a19bef379
            ...
            <div className="carousel-item">
              <img
                src="https://thumbs.dreamstime.com/b/hombre-cauc%C3%A1sico-hermoso-con-la-barba-76425603.jpg"
                className="d-block w-100"
                alt="..."
              />
            </div>
            <div className="carousel-item">
              <img
                src="https://www.dzoom.org.es/wp-content/uploads/2019/06/fotografia-paisaje-consejos-12.jpg"
                className="d-block w-100"
                alt="..."
              />
            </div>
